...
function Split() {
  ...
  const faqJsonLd = useMemo(
    () => (m.split.faq?.length ? faqPageJsonLd(m.split.faq, pageUrl('/split')) : null),
    [m.split.faq]
  );
  useJsonLd('one2pdf-faq-split', faqJsonLd);
    ...
    return (
      <StudioLanding
        ...
        seo={{
          ...
          howTitle: m.split.howTitle,
          howSteps: m.split.howSteps,
          faqTitle: m.split.faqTitle,
          faq: m.split.faq
        }}
