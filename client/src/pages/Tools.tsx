...
function Tools() {
  ...
  const popularTools: ToolDef[] = [
    ...
    { id: 'pdfToWord', name: m.tools.pdfToWord, path: '/pdf-to-word', icon: 'W', color: '#2684ff', badge: 'new', keywords: 'word docx office' },
    { id: 'wordToPdf', name: m.tools.wordToPdf, path: '/word-to-pdf', icon: 'W', color: '#2684ff', badge: 'new', keywords: 'word docx office' },
    ...
    { id: 'pdfToExcel', name: m.tools.pdfToExcel, path: '/pdf-to-excel', icon: 'X', color: '#18a957', badge: 'new', keywords: 'excel xlsx office' },
  ...
  const otherTools: ToolDef[] = [
    ...
    { id: 'excelToPdf', name: m.tools.excelToPdf, path: '/excel-to-pdf', icon: 'X', color: '#18a957', badge: 'new', keywords: 'excel xlsx office' },
    { id: 'pdfToPpt', name: m.tools.pdfToPpt, path: '/pdf-to-ppt', icon: 'P', color: '#f05b43', badge: 'new', keywords: 'powerpoint pptx office' },
    { id: 'pptToPdf', name: m.tools.pptToPdf, path: '/ppt-to-pdf', icon: 'P', color: '#f05b43', badge: 'new', keywords: 'powerpoint pptx office' },
