    ...
    <div className="pdf-to-word-page">
      <div className="pdf-to-word-container">
        <div className="breadcrumbs">
          ...
          <span className="current">PDF en Word</span>
        </div>

        <div className="pdf-to-word-header">
          <h1>PDF en Word</h1>
          <p>Convertissez vos fichiers PDF en documents Word éditables</p>
        </div>

        <main className="pdf-to-word-content">
          {!downloadUrl ? (
            <>
              <FileUpload 
                multiple={true}
              ...
              {files.length > 0 && (
                <div className="pdf-to-word-actions">
                  <button
            ...
            <div className="success-container">
              ...
              <p>Vos fichiers PDF ont été convertis en documents Word.</p>
