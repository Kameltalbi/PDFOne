...
export const it: Messages = {
  ...en,
  htmlTitle: 'PDFOne — Strumenti PDF',
  ...
  home: { ...en.home, eyebrow: 'SEMPLICE, VELOCE E SICURO', title: 'I tuoi documenti PDF,', titleAccent: 'finalmente facili da gestire.', ctaEdit: 'Modifica un PDF', ctaTools: 'Scopri tutti gli strumenti', trustInstall: 'Senza installazione', trustSize: 'Fino a 100 MB', trustDelete: 'File eliminati automaticamente', seeAllTools: 'Vedi tutti gli strumenti', ctaButton: 'Esplora gli strumenti', footerTagline: 'La cassetta degli attrezzi PDF semplice e professionale.', filesDeleted: 'I file vengono eliminati automaticamente dopo l’elaborazione.' },
