...
export const it: Messages = {
  ...
  home: { ...en.home, eyebrow: 'SEMPLICE, VELOCE E SICURO', title: 'I tuoi documenti PDF,', titleAccent: 'finalmente facili da gestire.', ctaEdit: 'Modifica un PDF', ctaTools: 'Scopri tutti gli strumenti', trustInstall: 'Senza installazione', trustSize: '50 MB in gratuito', trustDelete: 'File eliminati automaticamente', seeAllTools: 'Vedi tutti gli strumenti', ctaButton: 'Esplora gli strumenti', footerTagline: 'La cassetta degli attrezzi PDF semplice e professionale.', filesDeleted: 'I file vengono eliminati al download (max 15 min).' },
