...
export type Messages = {
  ...
  account: {
    ...
    signupAsideTitle: string;
    signupAsideText: string;
    signupSeoTitle: string;
    signupSeoDescription: string;
  ...
  home: {
    ...
    plansFreeTitle: string;
    plansFreeDesc: string;
    plansFreePoints: string[];
    plansFreeCta: string;
    plansPassLabel: string;
    plansPassTitle: string;
    plansPassDesc: string;
    plansPassPoints: string[];
    plansPassHighlight: string;
    plansPassCta: string;
    plansProLabel: string;
    plansProTitle: string;
    plansProDesc: string;
    plansProPoints: string[];
    plansProCta: string;
    plansReassureTitle: string;
    plansReassureText: string;
    plansReassureItems: string[];
    plansSeeAll: string;
  };
  about: {
    seoTitle: string;
    ...
    platformP2: string;
    platformP3: string;
    platformClose: string;
    catConvert: string;
    catConvertText: string;
    catCompress: string;
    catCompressText: string;
    catMerge: string;
    catMergeText: string;
    catSplit: string;
    catSplitText: string;
    catOrganize: string;
    catOrganizeText: string;
    catOcr: string;
    catOcrText: string;
    howKicker: string;
    howTitle: string;
    ...
    principle4Text: string;
    principle5Title: string;
    principle5Text: string;
    intlKicker: string;
    intlTitle: string;
    intlP1: string;
    intlP2: string;
