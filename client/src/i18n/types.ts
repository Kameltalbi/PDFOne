...
export type Messages = {
  ...
  home: {
    ...
    freeValueTitle: string;
    freeValueText: string;
    freeValueFreeTitle: string;
    freeValueFreeText: string;
    freeValueSimpleTitle: string;
    freeValueSimpleText: string;
    freeValueSecureTitle: string;
    freeValueSecureText: string;
    freeValueCta: string;
  };
  about: {
    seoTitle: string;
